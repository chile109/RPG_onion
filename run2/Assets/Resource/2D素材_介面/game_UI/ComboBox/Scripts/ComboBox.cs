...
public class ComboBox : MonoBehaviour 
{
	...
	public void OnItemClicked(int index)
	{
		...
		temp_text = Items[SelectedIndex].Caption;
	...
	public void InitControl()
	{
		...
		scrollbarColors.normalColor = new Color32(128, 128, 128, 255);
		scrollbarColors.highlightedColor = new Color32(128, 128, 128, 255);
		scrollbarColors.pressedColor = new Color32(88, 88, 88, 255);
		scrollbarColors.disabledColor = new Color32(64, 64, 64, 255);
		...
		handleImage.color = new Color32(100, 100, 100, 255);
